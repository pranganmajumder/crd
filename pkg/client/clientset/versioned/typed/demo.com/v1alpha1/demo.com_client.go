...
// DemoV1alpha1Client is used to interact with features provided by the demo.com group.
type DemoV1alpha1Client struct {
	restClient rest.Interface
}

func (c *DemoV1alpha1Client) UserInfos(namespace string) UserInfoInterface {
	return newUserInfos(c, namespace)
}
